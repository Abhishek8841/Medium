...
export type BlogOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "id" | "title" | "description" | "createdAt" | "updatedAt", ExtArgs["result"]["blog"]>
...
export interface BlogDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const blogWithUserIdOnly = await prisma.blog.findMany({ select: { userId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Blogs and only return the `userId`
   * const blogWithUserIdOnly = await prisma.blog.createManyAndReturn({
   *   select: { userId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Blogs and only return the `userId`
   * const blogWithUserIdOnly = await prisma.blog.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
